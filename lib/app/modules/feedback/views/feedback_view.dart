                ...
                children: [
                  ...
                  Obx(
                    () => Wrap(
                      spacing: 10,
                      runSpacing: 10,
                      children: controller.q1.map((option) {
                        return SizedBox(
                          width: Get.width / 2 - 20, // half width
                          child: RadioListTile<String>(
                            title: textNormalStart(option, Colors.white, 12.0),
                            value: option,
                  ...
                  Obx(
                    () => Wrap(
                      spacing: 10,
                      runSpacing: 10,
                      children: controller.q2.map((option) {
                        return SizedBox(
                          width: Get.width / 2 - 20, // half width
                          child: RadioListTile<String>(
                            title: textNormalStart(option, Colors.white, 12.0),
                  ...
                  Obx(
                    () => Wrap(
                      spacing: 10,
                      runSpacing: 10,
                      children: controller.q3.map((option) {
                        return SizedBox(
                          width: Get.width / 2 - 20, // half width
                          child: RadioListTile<String>(
                            title: textNormalStart(option, Colors.white, 12.0),
                  ...
                  Obx(
                    () => Wrap(
                      spacing: 10,
                      runSpacing: 10,
                      children: controller.q4.map((option) {
                        return SizedBox(
                          width: Get.width / 2 - 20, // half width
                          child: RadioListTile<String>(
                            title: textNormalStart(option, Colors.white, 12.0),
                  ...
                  Obx(
                    () => Wrap(
                      children: controller.q5.map((option) {
                        return SizedBox(
                          width: Get.width / 2 - 20, // half width
                          child: RadioListTile<String>(
                            title: textNormalStart(option, Colors.white, 12.0),
                            value: option,
                            groupValue: controller.selectedQ5.value,
                            onChanged: (value) {
                              controller.selectedQ5(value!);
                            },
                          ),
                        );
                      }).toList(),
